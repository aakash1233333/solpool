...
export declare type SolflareIframeResizeMessage = {
    type: 'resize';
    id: string;
} & (SolflareIframeResizeCoordinatesMessage | SolflareIframeResizeMode);
export declare type SolflareIframeMessage = SolflareIframeResponseMessage | SolflareIframeEventMessage | SolflareIframeResizeMessage;
