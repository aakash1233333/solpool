...
import type { ConnectFeature, DisconnectFeature } from '@wallet-standard/features';
...
export declare class SolanaWalletAdapterWallet implements Wallet {
    ...
    get features(): ConnectFeature & DisconnectFeature & SolanaSignAndSendTransactionFeature & Partial<SolanaSignTransactionFeature & SolanaSignMessageFeature>;
