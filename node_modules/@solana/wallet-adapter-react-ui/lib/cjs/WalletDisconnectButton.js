...
const WalletDisconnectButton = (_a) => {
    ...
    return (react_1.default.createElement(Button_js_1.Button, Object.assign({ className: "wallet-adapter-button-trigger", disabled: disabled || !wallet, startIcon: wallet ? react_1.default.createElement(WalletIcon_js_1.WalletIcon, { wallet: wallet }) : undefined, onClick: handleClick }, props), content));
};
