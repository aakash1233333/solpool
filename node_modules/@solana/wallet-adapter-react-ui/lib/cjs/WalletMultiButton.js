...
const WalletConnectButton_js_1 = require("./WalletConnectButton.js");
const WalletIcon_js_1 = require("./WalletIcon.js");
const WalletModalButton_js_1 = require("./WalletModalButton.js");
const WalletMultiButton = (_a) => {
    ...
    if (!wallet)
        return react_1.default.createElement(WalletModalButton_js_1.WalletModalButton, Object.assign({}, props), children);
    if (!base58)
        return react_1.default.createElement(WalletConnectButton_js_1.WalletConnectButton, Object.assign({}, props), children);
    return (react_1.default.createElement("div", { className: "wallet-adapter-dropdown" },
        react_1.default.createElement(Button_js_1.Button, Object.assign({ "aria-expanded": active, className: "wallet-adapter-button-trigger", style: Object.assign({ pointerEvents: active ? 'none' : 'auto' }, props.style), onClick: openDropdown, startIcon: react_1.default.createElement(WalletIcon_js_1.WalletIcon, { wallet: wallet }) }, props), content),
